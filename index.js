...
let totalRaised = GAMES_JSON.reduce((acc,game)=>{
    return acc = acc + game.pledged;
},0)

// set inner HTML using template literal
raisedCard.innerHTML=`$${totalRaised.toLocaleString()}</p>
`
...
const descriptionText = `
    <p>
        A total of $${totalRaised.toLocaleString()} has beeen raised but ${unfundedCount} ${unfundedCount === 1 ? "game remains" : "games remain"} unfunded.
...
runnerUpEl.innerHTML = runnerUpGame.name;
